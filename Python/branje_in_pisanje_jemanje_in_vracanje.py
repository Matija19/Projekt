# =============================================================================
# Branje in pisanje, jemanje in vračanje
# =====================================================================@009830=
# 1. podnaloga
# Sestavite funkcijo `vzemi_vrni(n)`, ki vrne niz `n`.
# =============================================================================

# =====================================================================@009831=
# 2. podnaloga
# Sestavite funkcijo `beri_vrni()`, ki vrne niz, ki ga je vnesel uporabnik.
# =============================================================================

# =====================================================================@009832=
# 3. podnaloga
# Sestavite funkcijo `vzemi_izpisi(n)`, ki izpiše niz `n`.
# =============================================================================

# =====================================================================@009840=
# 4. podnaloga
# Sestavite funkcijo `beri_izpisi()`, ki izpiše niz, ki ga je vnesel uporabnik.
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        try:
            Check.equal("vzemi_vrni('xxx')", 'xxx')
        except:
    ...
    if Check.part():
        try:
            with Check.input(['xxx']):
                Check.equal('beri_vrni()', 'xxx')
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            Check.output("vzemi_izpisi('xxx')", ['xxx'], use_globals=True)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        try:
            with Check.input(['xxx']):
                Check.output('beri_izpisi()', ['xxx'], use_globals=True)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
